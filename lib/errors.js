...
const ERROR_SUGGESTIONS = [
  {
    ...
    suggestion: 'Run "agent-orbit init" to set up your configuration.',
  },
  {
  ...
  },
  {
    ...
    suggestion: [
      ...
      '  Try: agent-orbit pull   (to get latest changes first)',
      '  Then: agent-orbit sync  (to push again)',
    ].join('\n'),
  },
  {
  ...
  },
  {
    ...
    suggestion: 'This workspace is already in your sync list. Use "agent-orbit list" to see all workspaces.',
  },
  {
    pattern: /Workspace not found/i,
    suggestion: 'This workspace is not in your sync list. Use "agent-orbit list" to see registered workspaces.',
  },
  {
    pattern: /lock.*stuck|Could not acquire git lock/i,
    suggestion: [
      'The git lock file may be stale from a previous interrupted operation.',
      '  Delete it manually: rm ~/.config/agent-orbit/git.lock',
  ...
  },
  {
    ...
    suggestion: [
      ...
      '  1. cd ~/.config/agent-orbit/repo',
      '  2. Resolve conflicts manually',
      '  3. git add . && git commit',
      '  4. Retry your agent-orbit command',
    ].join('\n'),
  },
  {
  ...
  },
  {
    ...
    suggestion: 'Add a workspace first: agent-orbit add <path-to-your-workspace>',
  },
  {
    pattern: /PM2|daemon|pm2/i,
    suggestion: [
      'There was an issue with the background daemon (PM2).',
      '  Try: agent-orbit stop && agent-orbit start',
      '  Or use foreground mode: agent-orbit watch',
    ].join('\n'),
  },
];
