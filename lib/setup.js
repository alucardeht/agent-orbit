...
async function runSetup() {
  ...
  try {
    ...
    if (isPM2Installed()) {
      ...
      console.log(chalk.cyan('\n[Orbit] Automatically enabling background native autostart daemon...'));
      ...
      console.log(chalk.green('[Orbit] Watcher background daemon is active via native autostart service.'));
    }
